...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Nov 2025 pada 15.15
...
INSERT INTO `users` (`id`, `username`, `password`, `role`, `nama_user`) VALUES
(1, 'admin', 'admin123', 'admin', 'Administrator'),
(2, 'pelanggan1', 'user123', 'user', 'Budi'),
(3, 'pelanggan2', 'pass123', 'user', 'Siti');
